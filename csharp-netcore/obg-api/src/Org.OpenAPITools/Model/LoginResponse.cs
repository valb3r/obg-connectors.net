...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class LoginResponse : IEquatable<LoginResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="xsrfToken">Authorization cookie hash.</param>
        public LoginResponse(string xsrfToken = default(string))
        {
        ...
        /// </summary>
        /// <value>Authorization cookie hash</value>
        [DataMember(Name = "xsrfToken", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  XsrfToken: ").Append(XsrfToken).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(LoginResponse input)
        {
            ...
            return 
                (
                    this.XsrfToken == input.XsrfToken ||
                    (this.XsrfToken != null &&
                    this.XsrfToken.Equals(input.XsrfToken))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.XsrfToken != null)
                    hashCode = hashCode * 59 + this.XsrfToken.GetHashCode();
                return hashCode;
            }
        }
